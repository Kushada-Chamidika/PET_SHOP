...
if (isset($_SESSION["id"])) {
    ...
    $result_lk = $con->query("SELECT * FROM pet_details WHERE `user_id`!='" . $id . "' AND `status`='available'");
...
<html>
    ...
    <div class="divup">
        ...
        <a href="myreservations.php">
            <span class="tit1 tita titx">My Reservations</span>
        </a>
    ...
    if ($rwcount > 0) {
        while ($rowlk = mysqli_fetch_assoc($result_lk)) {
            ?>
            <div class="detaildiv"  id="<?php echo $rowlk["add_id"]; ?>">
                <div class="imgdiv">
                ...
                <form action="buy.php" method="POST">
                    ...
                    <input type="submit" value="Reserve" class="buy" onclick="animation(<?php echo $rowlk["add_id"]; ?>)"/>
                </form>
